...
class LiquidationTest(unittest.TestCase):
    ...
    def test_basic_liquidation(self):
        result = Liquida_nomina1.CalcularLiquidacion(monthly_salary=1500000, weeks_worked=24)
        self.assertEqual(result, 6773040.0)

    def test_complete_liquidation(self):
        result = Liquida_nomina1.CalcularLiquidacion(monthly_salary=1300000, weeks_worked=7, overtime_day_hours=13,
    ...
    def test_liquidation_with_overtime(self):
        result = Liquida_nomina1.CalcularLiquidacion(monthly_salary=2200000, weeks_worked=26, 
                                                     overtime_day_hours=10, overtime_night_hours=5)
        self.assertEqual(result, 10853048.33)
    
    def test_normal_liquidation(self):
        result = Liquida_nomina1.CalcularLiquidacion(monthly_salary=3000000, weeks_worked=4, holiday_hours_worked=8, 
    ...
    def test_regular_liquidation(self):
        result = Liquida_nomina1.CalcularLiquidacion(monthly_salary=2000000, weeks_worked=14, holiday_hours_worked=5, 
    ...
    def test_natural_liquidation(self):
        result = Liquida_nomina1.CalcularLiquidacion(monthly_salary=2600000, weeks_worked=4, holiday_hours_worked=8, 
    ...
    def test_liquidation_with_sick_days(self):
        result = Liquida_nomina1.CalcularLiquidacion(monthly_salary=4000000, weeks_worked=20, sick_days=15)
        self.assertEqual(result, 14054000.0)

    def test_liquidation_with_retention(self):
        result = Liquida_nomina1.CalcularLiquidacion(monthly_salary=7000000, weeks_worked=8, sick_days=1)
        self.assertEqual(result, 9554300.0)

    def test_liquidation_without_transport(self):
        result = Liquida_nomina1.CalcularLiquidacion(monthly_salary=3000000, weeks_worked=10)
    ...
    def test_with_leave_days(self):
        ...
        weeks_worked = 3
        leave_days = 6
        result = Liquida_nomina1.CalcularLiquidacion(monthly_salary, weeks_worked, leave_days)
        self.assertEqual(result, 741290.0)

    def test_low_salary_liquidation(self):
        result = Liquida_nomina1.CalcularLiquidacion(monthly_salary=900000, weeks_worked=2)
        self.assertEqual(result, 480240.0)  # Low salary
    
    def test_one_leave_day(self):
        result = Liquida_nomina1.CalcularLiquidacion(monthly_salary=1900000, weeks_worked=12, 
                                                     leave_days=1)
    ...
    def test_negative_salary(self):
        ...
        with self.assertRaises(Liquida_nomina1.NegativeValue):
            result = Liquida_nomina1.CalcularLiquidacion(monthly_salary, weeks_worked)
           
    def test_weeks_worked_zero(self):
        monthly_salary = 2000000
        weeks_worked = 0 
        with self.assertRaises(Liquida_nomina1.ZeroWeeks):
            result = Liquida_nomina1.CalcularLiquidacion(monthly_salary, weeks_worked)
    ...
    def test_negative_daytime_overtime_hours(self):
        ...
        with self.assertRaises(Liquida_nomina1.NegativeValue):
            result = Liquida_nomina1.CalcularLiquidacion(monthly_salary, weeks_worked, overtime_day_hours)
    ...
    def test_liquidation_more_than_8h_holiday(self):
        ...
        sick_days = 5
        with self.assertRaises(Liquida_nomina1.MoreThan8HoursHolidayWorked):
            result = Liquida_nomina1.CalcularLiquidacion(monthly_salary, weeks_worked, holiday_hours_worked, 
    ...
    def test_liquidation_non_numeric_overtime_hours(self):
        with self.assertRaises(Liquida_nomina1.InvalidValue):
            result = Liquida_nomina1.CalcularLiquidacion(monthly_salary=3000000, weeks_worked=4, holiday_hours_worked=10, 
                                                        overtime_day_hours="five", overtime_night_hours=3, holiday_overtime_hours=2, sick_days=5)        
