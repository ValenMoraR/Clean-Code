...
class LiquidationTest(unittest.TestCase):
    ...
    def test_basic_liquidation(self):
        result= Liquida_nomina1.Liquidacion(monthly_salary=1500000, weeks_worked=24)
    ...
    def test_liquidation_with_overtime(self):
        result = Liquida_nomina1.Liquidacion(monthly_salary=2200000, weeks_worked=26, 
    ...
    def test_liquidation_with_sick_days(self):
        result = Liquida_nomina1.Liquidacion(monthly_salary=4000000, weeks_worked=20, sick_days=15)
        self.assertEqual(result.CalcularLiquidacion(), 14054000.0)

    def test_liquidation_with_retention(self):
        result = Liquida_nomina1.Liquidacion(monthly_salary=7000000, weeks_worked=8, sick_days=1)
        self.assertEqual(result.CalcularLiquidacion(), 9554300.0)

    def test_liquidation_without_transport(self):
        result = Liquida_nomina1.Liquidacion(monthly_salary=3000000, weeks_worked=10)
    ...
    def test_with_leave_days(self):
        ...
        weeks_worked = 3
        leave_days = 6
        result = Liquida_nomina1.Liquidacion(monthly_salary, weeks_worked, leave_days)
        self.assertEqual(result.CalcularLiquidacion(), 741290.0)

    def test_low_salary_liquidation(self):
        result = Liquida_nomina1.Liquidacion(monthly_salary=900000, weeks_worked=2)
        self.assertEqual(result.CalcularLiquidacion(), 480240.0)  # Low salary
    
    def test_one_leave_day(self):
        result = Liquida_nomina1.Liquidacion(monthly_salary=1900000, weeks_worked=12, 
                                                     leave_days=1)
